...
function sfsi_footer_script()
{
	...
	if($sfsi_section1['sfsi_google_display']=="yes" || $sfsi_section1['sfsi_youtube_display']=="yes")
	{ ?>
	...
	if($sfsi_section1['sfsi_share_display']=="yes" || $sfsi_section6['sfsi_show_Onposts']=="yes")
	{ ?>
	 	<!-- Addthis js -->
