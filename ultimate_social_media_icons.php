...
if(!get_option('sfsi_pluginVersion') || get_option('sfsi_pluginVersion') < 1.90)
{
...
{
	$links[] = '<a target="_blank" href="https://wordpress.org/support/plugin/ultimate-social-media-icons#no-topic-0" id="sfsi_deactivateButton" style="color:#FF0000;"><b>Ask a question</b></a>';	
